...
class ApiIngredient {
  static Future<List<dynamic>> ingredients() async {
    try {
      String url = ('${AppConfig.BASE_URL}/ingredient');
      ...
      if (kDebugMode) {
        print("ApiIngredient ingredients error: $e");
      }
      return [];
    }
  }
  ...
  static Future<bool> insert(Map<String, dynamic> body) async {
    try {
      ...
      if (kDebugMode) {
        print("ApiIngredient insert error: $e");
      }
      return false;
    }
  }
  ...
  static Future<bool> update(Map<String, dynamic> body, String id) async {
    try {
      String url = ('${AppConfig.BASE_URL}/ingredient/$id');
      final response = await ApiRequest.post(url: url, body: jsonEncode(body));
      if (response.statusCode == 200) {
        return true;
      }
      ...
      if (kDebugMode) {
        print("ApiIngredient update error: $e");
      }
      return false;
    }
  }
