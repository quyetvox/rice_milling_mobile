...
class AcnooMultiSelectDropdown<T> extends StatefulWidget {
  ...
  @override
  State<AcnooMultiSelectDropdown<T>> createState() =>
      _AcnooMultiSelectDropdownState<T>();
}

class _AcnooMultiSelectDropdownState<T>
    extends State<AcnooMultiSelectDropdown<T>> {
  bool isOpen = false;
